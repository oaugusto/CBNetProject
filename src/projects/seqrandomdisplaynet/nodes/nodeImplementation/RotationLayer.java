package projects.seqrandomdisplaynet.nodes.nodeImplementation;

import java.util.HashMap;

import projects.randomdisplaynet.nodes.messages.CBNetMessage;
import projects.randomdisplaynet.nodes.nodeImplementations.CBTreeLayer;
...
//     if (true) {
//     if (false) {
    if (this.cbnetMessage.isOnlyRotation()) {
      this.rotating = true;
