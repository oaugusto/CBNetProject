package projects.randomdisplaynet;
...
import projects.randomdisplaynet.nodes.nodeImplementations.CBNetApp;
import projects.randomdisplaynet.nodes.timers.TriggerNodeOperation;
  ...
  public void preRun() {
    ...
    try {
      ...
      if (Configuration.hasParameter("p")) {
        double exp = (double) Configuration.getIntegerParameter("p");
        p = 1 / Math.pow(2, exp);
      }
