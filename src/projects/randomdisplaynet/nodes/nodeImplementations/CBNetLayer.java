...
import projects.randomdisplaynet.CustomGlobal;
import projects.randomdisplaynet.nodes.messages.CBNetMessage;
import projects.randomdisplaynet.nodes.messages.CompletionMessage;
...
//	private double p = 0.5; // probability of splaying the message
    ...
    public void sendCBNetMessage(int dst, double priority) {
        ...
        CBNetMessage msg = new CBNetMessage(ID, dst, priority, rand.nextDouble() <= CustomGlobal.p /*onlyRotation*/);
