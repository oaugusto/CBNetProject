package projects.randomdisplaynetAdapt.nodes.messages;
...
public class CBNetMessage extends Message implements Comparable<CBNetMessage> {
  ...
  public CBNetMessage(int src, int dst, double priority, boolean onlyRotation) {
    this.src = src;
    this.dst = dst;
    this.priority = priority;
    this.onlyRotation = onlyRotation;
