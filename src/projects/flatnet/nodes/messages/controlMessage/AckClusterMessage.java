...
public class AckClusterMessage extends Message {
    ...
    private FlatInfo info;

    private int position;
    private boolean isFinalNode; // keep track if this node is final node in current request

    public AckClusterMessage(int src, int dst, double priority, int position, FlatInfo info) {
        this.src = src;
        this.dst = dst;
    ...
    public void setInfo(FlatInfo info) {
        this.info = info;
    }
