 ...
 */
 ...
 public class FlatNetMessage extends Message implements Comparable<FlatNetMessage> {
    ...
    public FlatNetMessage(int src, int dst, double priority) {
        this.src = src;
        this.dst = dst;
